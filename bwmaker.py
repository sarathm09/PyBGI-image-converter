...
print "\n This program can convert an image file(jpg, png supported) to a C program (Yup, that's right). All thanks to the developers of Turbo C BGI graphics and Python. It's not just a simple program, So just check it out!!!"
